  ...
  const categories = [
    {
      ...
      img: tools,
      link: '/products/buy/bcb/tools',
    },
    {
      name: 'Physiotherapy Equipment',
      img: equipments,
      link: '/products/buy/bcb/equipments',
    },
    {
      name: 'Physiotherapy Devices',
      img: devices,
      link: '/products/buy/bcb/devices',
    },
    {
      name: 'Accessories',
      img: accessories,
      link: '/products/buy/bcb/accessories',
    },
  ]
  return (
    <div className='flex-1 bg-gradient-to-b from-[#f8f8f8] from-0% to-white to-100%'>
      <div className='flex flex-row items-center gap-12 w-full max-w-7xl mx-auto px-7 mt-16 md:mt-20'>
        <h2 className='font-medium text-3xl md:text-5xl'>BUY B2B</h2>
