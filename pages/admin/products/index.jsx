...
const Products = () => {
  ...
  return (
    <>
      ...
      {/* Fixed header */}
      <div className='bg-primary text-white px-6 xl:px-20 py-8 flex justify-between items-center fixed top-[155px] md:top-0 w-full md:w-[calc(100%-288px)] z-10 right-0'>
